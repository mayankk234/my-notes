    ...
    <StyledWrapper>
      <div className="brutalist-card">
        ...
        <div className="brutalist-card__actions">
          <a className="brutalist-card__button brutalist-card__button--mark" href="#">Sign In</a>
          <a className="brutalist-card__button brutalist-card__button--read" href="#">Sign Up</a>
        </div>
      </div>
    </StyledWrapper>
  );
