    ...
    <StyledWrapper>
      ...
      <div className="title">
          <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
            <svg className="icon" height="24px" width="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{cursor: 'pointer'}} onClick={() => window.history.back()}>
        ...
        <input type="password" placeholder="Repeat Password" name="password2" className="input" />
